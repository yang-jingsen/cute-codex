...
pub enum RolloutItem {
    ...
    InterAgentCommunicationMetadata {
        trigger_turn: bool,
        delivery_receipt: Option<InterAgentDeliveryReceipt>,
        model_action: Option<InterAgentModelAction>,
    },
...
/// Durable A4 proof for one canonical inter-agent response item.
...
/// Durable reservation of an A4 message for one eligible model request.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, JsonSchema)]
pub struct InterAgentModelAction {
    pub message_id: String,
    pub semantic_sha256: String,
    pub turn_id: String,
    /// False reserves the eligible request; true durably proves nonempty model output.
    #[serde(default)]
    pub completed: bool,
}
