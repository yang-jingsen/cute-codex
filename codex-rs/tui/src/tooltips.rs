...
const APP_TOOLTIP: &str = "Try the **Desktop app**. Run 'cute-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const MACOS_APP_TOOLTIP: &str =
    "Run `cute-codex app` to open the Desktop app (it installs on macOS if needed).";
...
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Desktop app**. Run 'cute-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
