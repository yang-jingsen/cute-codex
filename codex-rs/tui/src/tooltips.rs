...
const APP_TOOLTIP: &str = "Try the **Codex App**. Run 'cute-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex App**. Run 'cute-codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("cute-codex app") {
                return false;
            }
            true
        })
