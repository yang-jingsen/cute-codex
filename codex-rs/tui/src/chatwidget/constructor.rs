...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            cutex_activity_handles: HashMap::new(),
            recovered_cutex_activity_handles: HashMap::new(),
            cutex_template_correlations: Default::default(),
            ...
            session_startup_idle_entered_at: None,
            session_startup_idle_notification_sent: false,
            session_startup_idle_generation: 0,
            session_startup_idle_timer_due_at: None,
            notify_service_session_started_sent_for: None,
            notify_service_replay_suppressed: false,
            ...
            custom_status_items: crate::custom_status_items::load_custom_status_items(),
