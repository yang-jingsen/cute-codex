...
pub(super) struct TranscriptState {
    ...
    /// Latest source occurrence time for a live typed activity that may own the next divider.
    pub(super) last_live_activity_occurred_at_seconds: Option<i64>,
...
impl TranscriptState {
    ...
    pub(super) fn reset_turn_flags(&mut self) {
        ...
        self.last_live_activity_occurred_at_seconds = None;
