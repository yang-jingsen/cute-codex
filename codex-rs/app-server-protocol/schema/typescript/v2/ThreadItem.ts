...
import type { ManagedAgentActivityItem } from "./ManagedAgentActivityItem";
...
import type { OutboundInterAgentMessageItem } from "./OutboundInterAgentMessageItem";
import type { PatchApplyStatus } from "./PatchApplyStatus";
import type { SubAgentActivityKind } from "./SubAgentActivityKind";
import type { TaskAssignmentActivityItem } from "./TaskAssignmentActivityItem";
import type { TaskServiceMessagePresentation } from "./TaskServiceMessagePresentation";
import type { TaskWatchdogActivityItem } from "./TaskWatchdogActivityItem";
import type { UserInput } from "./UserInput";

export type ThreadItem = { "type": "userMessage", id: string, clientId: string | null, content: Array<UserInput>, } | { "type": "hookPrompt", id: string, fragments: Array<HookPromptFragment>, } | { "type": "agentMessage", id: string, text: string, phase: MessagePhase | null, memoryCitation: MemoryCitation | null, delivery: AgentMessageDelivery | null, questions: Array<AsyncUserInputQuestion> | null, } | { "type": "interAgentMessage", id: string, author: string, recipient: string, otherRecipients: Array<string>, content: string, deliveryMode: InterAgentDeliveryMode, authorMetadata?: CutexParticipantPresentation, recipientMetadata?: CutexParticipantPresentation, taskServicePresentation?: TaskServiceMessagePresentation, } | { "type": "functionCallOutput", id: string, name: string, namespace: string | null, output: FunctionCallOutputBody, } | { "type": "plan", id: string, text: string, } | { "type": "reasoning", id: string, summary: Array<string>, content: Array<string>, } | { "type": "commandExecution", id: string,
/**
 ...
 */
agentsStates: { [key in string]?: CollabAgentState }, } | { "type": "subAgentActivity", id: string, kind: SubAgentActivityKind, agentThreadId: string, agentPath: string, } | { "type": "managedAgentActivity", activity: ManagedAgentActivityItem, } | { "type": "outboundInterAgentMessage", activity: OutboundInterAgentMessageItem, } | { "type": "taskAssignmentActivity", activity: TaskAssignmentActivityItem, } | { "type": "taskWatchdogActivity", activity: TaskWatchdogActivityItem, } | { "type": "webSearch" } & WebSearchItem | { "type": "imageView", id: string, path: LegacyAppPathString, } | { "type": "sleep" } & SleepItem | { "type": "imageGeneration" } & ImageGenerationItem | { "type": "enteredReviewMode", id: string, review: string, } | { "type": "exitedReviewMode", id: string, review: string, } | { "type": "contextCompaction", id: string, };
