...
client_request_definitions! {
    ...
    /// Deliver an inter-agent mailbox message to a loaded thread.
    ThreadInterAgentMessage => "thread/inter_agent_message" {
        params: v2::ThreadInterAgentMessageParams,
        serialization: thread_id(params.thread_id),
        response: v2::ThreadInterAgentMessageResponse,
    },
    /// Query volatile A3 and durable A4 state without serializing behind thread mutations.
    ThreadInterAgentMessageStatus => "thread/inter_agent_message/status" {
        params: v2::ThreadInterAgentMessageStatusParams,
        serialization: None,
        response: v2::ThreadInterAgentMessageStatusResponse,
    },
    /// Record a typed Cutex activity in a Director timeline without changing model context.
    ThreadCutexActivity => "thread/cutexActivity" {
        params: v2::ThreadCutexActivityParams,
        serialization: thread_id(params.thread_id),
        response: v2::ThreadCutexActivityResponse,
    },
...
server_notification_definitions! {
    ...
    CutexActivityPresented => "cutexActivity/presented" (v2::CutexUiActivityNotification),
