...
#[derive(Debug, Parser)]
#[command(bin_name = "cute-codex plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin marketplace add",
    after_help = "Examples:\n  cute-codex plugin marketplace add ./path/to/marketplace\n  cute-codex plugin marketplace add owner/repo --ref main\n  cute-codex plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "cute-codex plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin marketplace upgrade",
    after_help = "Examples:\n  cute-codex plugin marketplace upgrade\n  cute-codex plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin marketplace remove",
    after_help = "Example:\n  cute-codex plugin marketplace remove debug"
)]
