...
#[derive(Debug, Parser)]
#[command(bin_name = "cute-codex plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin add",
    after_help = "Examples:\n  cute-codex plugin add sample@debug\n  cute-codex plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin list",
    after_help = "Examples:\n  cute-codex plugin list\n  cute-codex plugin list --marketplace debug\n  cute-codex plugin list --json\n  cute-codex plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "cute-codex plugin remove",
    after_help = "Examples:\n  cute-codex plugin remove sample@debug\n  cute-codex plugin remove sample --marketplace debug"
)]
