...
fn turn_item_type(item: &TurnItem) -> &'static str {
    match item {
        ...
        TurnItem::ManagedAgentActivity(_) => "managed_agent_activity",
        TurnItem::OutboundInterAgentMessage(_) => "outbound_inter_agent_message",
        TurnItem::TaskAssignmentActivity(_) => "task_assignment_activity",
        TurnItem::TaskWatchdogActivity(_) => "task_watchdog_activity",
