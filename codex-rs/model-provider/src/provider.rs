...
pub struct ProviderCapabilities {
    ...
    pub supports_agent_message_items: bool,
}
...
impl Default for ProviderCapabilities {
    fn default() -> Self {
        Self {
            ...
            supports_agent_message_items: false,
        }
    }
}
...
impl ModelProvider for ConfiguredModelProvider {
    ...
    fn capabilities(&self) -> ProviderCapabilities {
        ...
        ProviderCapabilities {
            remote_compaction,
            supports_agent_message_items: self
                .info
...
mod tests {
    ...
    #[test]
    fn configured_provider_resolves_agent_message_capability() {
        let cases = [
            (
                ModelProviderInfo::create_openai_provider(/*base_url*/ None),
                true,
            ...
            (
                ModelProviderInfo {
                    supports_agent_message_items: Some(false),
                    ..ModelProviderInfo::create_openai_provider(/*base_url*/ None)
                },
                false,
            ),
        ...
        for (provider_info, expected) in cases {
            ...
            assert_eq!(
                provider.capabilities().supports_agent_message_items,
                expected
            );
        }
    }
