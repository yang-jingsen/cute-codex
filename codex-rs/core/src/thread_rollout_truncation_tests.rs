...
fn fork_turn_positions_use_canonical_agent_messages_and_delivery_metadata() {
    ...
    let mut rollout = vec![
        ...
        RolloutItem::InterAgentCommunicationMetadata {
            ...
            model_action: Some(InterAgentModelAction {
                message_id: "amsg_follow_up".to_string(),
    ...
    assert_eq!(fork_turn_positions_in_rollout(&rollout), vec![0, 4, 9]);
    ...
    assert_eq!(fork_turn_positions_in_rollout(&rollout), vec![0, 10]);
}
