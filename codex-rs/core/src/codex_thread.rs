...
use crate::inter_agent_delivery::InterAgentDeliveryStatus;
...
impl CodexThread {
    ...
    /// Reads volatile A3 and durable A4 delivery state without entering the submission queue.
    pub async fn inter_agent_delivery_status(
        &self,
