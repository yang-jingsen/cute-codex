...
impl TestAppServer {
    ...
    async fn new_with_program_env_and_args(
        ...
        // Ambient Cutex/GLM launch configuration must never override a test's
        // mock provider; otherwise analytics and turn fixtures observe a live
        // provider account and become order/environment dependent.
        for variable in [
            "CODEX_API_KEY",
            "CODEX_AUTH_FILE",
            "CODEX_CONFIG_FILE",
            ...
            "CODEX_LAUNCH_PROFILE_EMAIL",
            "CODEX_LAUNCH_PROFILE_SOURCE",
            "CODEX_LAUNCH_PROFILE_TYPE",
            "CODEX_LAUNCH_RUNTIME",
